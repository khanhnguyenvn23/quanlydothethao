...
public class common {
    ...
    public static Color second_gray = Color.decode("#D9D9D9");
    public static Color error = Color.decode("#FF0000");
    public static ImageIcon exit_icon = new ImageIcon("./src/images/exit_icon.png");
